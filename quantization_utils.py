...
# Attention: for add, mul, etc, some of them are from bn, activation layer, etc, don't quantize them twice
...
# todo: maybe modify here only can get what i want
